...
class contrastiveNet(nn.Module):
    def __init__(self, Npole, Drr, Dtheta, gumbel_inference_mode, gpu_id, data_dim, backbone_mode, dataType,fistaLam,fineTune,nClip, useCL):
